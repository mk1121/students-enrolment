...
router.get('/', [
  authenticateToken,
  query('status').optional().isIn(['pending', 'active', 'completed', 'cancelled', 'refunded']).withMessage('Invalid status'),
  ...
  try {
    ...
    const enrollments = await Enrollment.find(filter)
      .populate('course', 'title description thumbnail price duration instructor')
...
router.get('/:id', [
  ...
  try {
    const enrollment = await Enrollment.findById(req.params.id)
      .populate('course', 'title description thumbnail price duration instructor syllabus materials')
      .populate('student', 'firstName lastName email')
...
router.post('/', [
  ...
  try {
    ...
    await enrollment.populate([
      { path: 'course', select: 'title description thumbnail price duration instructor' },
