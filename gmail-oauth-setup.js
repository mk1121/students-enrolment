...
function getAuth(auth) {
  ...
  console.log(
    '   Access Token:',
    auth.credentials.access_token ? 'Present' : 'Not present'
  );
  console.log(
    '   Refresh Token:',
    auth.credentials.refresh_token ? 'Present' : 'Not present'
  );
  console.log(
    '   Expiry Date:',
    auth.credentials.expiry_date
      ? new Date(auth.credentials.expiry_date).toLocaleString()
      : 'Not set'
  );
